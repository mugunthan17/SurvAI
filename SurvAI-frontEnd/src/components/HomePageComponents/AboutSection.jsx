  ...
  return (
    <section id="about" className="py-36 px-6 text-center">
      ...
      <p className="text-[#555555] text-lg pop max-w-6xl mx-auto text-center">
        ...
        That’s why we built an AI-first platform that turns raw survey responses
        into real insights & summarizes them in seconds with the help of AI.
        Whether you're a Product Manager, a HR leader, a Business Analyst,
        SurvAI is here to summarize survey responses faster, smarter &
        insightful.{" "}
        <Link
          to="/about-us"
